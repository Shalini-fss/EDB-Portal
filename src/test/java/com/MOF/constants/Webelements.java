...
public class Webelements {
	...
	public static final String download = "//button[text()='Download']";
	...
	public static final String roleeditbtn = "//a[@href='/servicecatalogueportal/role/65']";
	public static final String roleDeletebtn = "//a[@href='/servicecatalogueportal/role/delete/65']";
	public static final String roleDeletebtnARAB = "//a[@href='/servicecatalogueportal/role/delete/959']";
	
	//ENTITY EDIT AND DELETE
	public static final String Entityeditbtn = "//a[@href='/servicecatalogueportal/editEntity/159']";
	public static final String EntityDeletebtn1 = "//a[@href='/servicecatalogueportal/deleteEntity/159']";
	public static final String EntityDeletebtn2 = "//a[@href='/servicecatalogueportal/deleteEntity/217']";
	public static final String EntityDeletebtn3 = "//a[@href='/servicecatalogueportal/deleteEntity/342']";
	public static final String EntityDeletebtn4 = "//a[@href='/servicecatalogueportal/deleteEntity/159']";
	public static final String EntityDeletebtn = "//a[@href='/servicecatalogueportal/deleteEntity/217']";
	
	
	//Group View And Delete
	public static final String GroupDeletebtn ="//a[@href='/servicecatalogueportal/group/delete/1222']";
	
	public static final String GroupViewbtn ="//a[@href='/servicecatalogueportal/group/11142024']";
	...
	public static final String srvcView="//a[@href='/servicecatalogueportal/viewServiceValue/30022022']";
	public static final String srvcedit="//a[@href='/servicecatalogueportal/editServiceValue/30022022']";
	public static final String sndforReview="//a[@href='/servicecatalogueportal/service/review/30022022']";
	public static final String approve="//label[text()='Approve']";
	public static final String reject="//label[text()='Reject']";
	...
	public static final String ServiceNameEnglish = "//input[@id='serviceNameEnglish']";
	public static final String ServiceNameArabic = "//input[@id='serviceNameArabic']";
	...
	public static final String servchk = "(//input[@name='serviceId'])[2]";
	...
	public static final String UserFullname = "//*[@id='name']";
	public static final String Username1 = "//*[@id='usernameValidation']";
	public static final String Password1 = "//input[@id='exampleInputPassword']";
	public static final String togglepwd = "//i[@id='togglePassword']";
	public static final String confirmPassword = "//input[@id='exampleInputConfirmPassword']";
	...
	// USER EDIT @ Delete
	public static final String userEdit = "//a[@href='/servicecatalogueportal/user/49']";
	public static final String EditUsername = "//a[@href='/servicecatalogueportal/user/49']";
	public static final String EditPassword = "//a[@href='/servicecatalogueportal/user/49']";
	public static final String EditRole = "//a[@href='/servicecatalogueportal/user/49']";
	public static final String EditEmailID = "//a[@href='/servicecatalogueportal/user/49']";
	public static final String EditCheckerbox = "//a[@href='/servicecatalogueportal/user/49']";
	public static final String EditDeselectCheckerbox = "//a[@href='/servicecatalogueportal/user/49']";
	public static final String EditUserActiveCheckbox = "//a[@href='/servicecatalogueportal/user/49']";
	public static final String userDeletebtn ="//a[@href='/servicecatalogueportal/user/delete/49']";
    ...
    public static final String View = "//button[text()='View	']";
	...
	public static final String userLogout = "//*[@id='accordionSidebar']/div/li[10]/a";
