...
public class MOFapi extends API_Excelutilities {
    ...
    public void initializeReports() throws Exception {
        ...
        // Define the directory path for storing response files and reports
        String directoryPath = "D:\\Desktop backup\\Desktop backup\\Automation\\API\\JSON\\";
        ...
        // Initialize the file writer for response data
        file = new FileWriter(directoryPath + "\\ServiceCatalogueAPI_" + FileName + ".json");
        System.out.println("Response file initialized at: " + directoryPath + "\\ServiceCatalogueAPI_" + FileName + ".json");

        // Initialize ExtentReports with a unique report path
        reports = new ExtentReports(directoryPath + "\\MOF_SERVICECATALOGUE_API_" + FileName + ".html");
        System.out.println("ExtentReports initialized at: " + directoryPath + "\\MOF_SERVICECATALOGUE_API_" + FileName + ".html");
    }
    ...
    public void GetServiceInquiry() throws Exception {
        ...
        try {
            ...
            file.write("\nFetch all services\n" + Fetchallservice);
            System.out.println("Response File: ServiceCatalogueAPI_<timestamp>.json");
