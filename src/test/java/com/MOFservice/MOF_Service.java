...
public class MOF_Service extends Screenshot {
...

	{
		...
		reports = new ExtentReports("D:\\Automation\\API\\PORTAL Report\\"+ " " + FileName);
	...
	public static void openBrowser() throws IOException, Exception {
	    ...
	    WebDriverManager.chromedriver().clearResolutionCache().driverVersion("136.0.7103.93").setup();
	...
	public static void login() throws Exception {
	    ...
	    // Enter Password
	    WebElement InputPassword = driver.findElement(By.xpath(Webelements.Inputpassword));
	    ...
	    Thread.sleep(600);
	    WebElement eyepwd = driver.findElement(By.xpath(Webelements.togglePassword));
	    eyepwd.click();
	    ...
	    InputPassword.click();
	    Thread.sleep(600);
	    WebElement loginbtn = driver.findElement(By.xpath("//*[@id=\"login\"]/a/label"));
	    loginbtn.click();
	...
	public void clicklogin_ENG() throws AWTException, InterruptedException {
	    if (driver.getPageSource().contains("Login")) {
	        ...
	        WebElement ENG_Loginbtn = driver.findElement(By.xpath(Webelements.ENG_Loginbtn));
	        ENG_Loginbtn.click();
	...
	public void clicklogin_ARAB() throws InterruptedException {
	    ...
	    WebElement ARAB_Loginbtn = driver.findElement(By.xpath(Webelements.ARAB_Loginbtn));
	    ARAB_Loginbtn.click();
	...
	public void changeloginLang() throws Exception {
	    ...
	    WebElement changelabelLang = driver.findElement(By.xpath(Webelements.changelabelLang));
	    changelabelLang.click();
	    ...
	    WebElement changeArabLang = driver.findElement(By.xpath(Webelements.changeArabLang));
	    changeArabLang.click();
	...
	public void Fsslogoclick() {
	    try {
	        ...
	        WebElement logo = driver.findElement(By.xpath(Webelements.logo));
	        logo.click();
	...
	// _STARTS*****************************************************
	@Test
	public static void clickroleTab() throws InterruptedException {
	    // Locate and click the Role tab
	    WebElement roletab = driver.findElement(By.xpath(Webelements.RoleTab));
	    roletab.click();
	...
	@Test
	public static void clickroleTabARAB() throws InterruptedException {
	    // Locate and click the ARAB Role tab
	    WebElement roletabARAB = driver.findElement(By.xpath(Webelements.RoleTabARAB));
	    roletabARAB.click();
	...
	@Test
	public static void CreateNewRole() throws Exception {
	    // First, click the Role tab
	    clickroleTab(); 

	    // Locate and enter the Role Name
	    WebElement roleName = driver.findElement(By.xpath(Webelements.EnterRoleName));
	...
	public static void CreateNewRoleARAB() throws Exception {
	    // Locate the role name field and enter the role name
	    WebElement roleNameARAB = driver.findElement(By.xpath(Webelements.EnterRoleName));
	...
	@Test
	public static void enterroleName() throws Exception {
	...
	@Test
	public static void selectrole() throws Exception {
	    // Click on the Role Access checkbox
	    WebElement RoleAccess = driver.findElement(By.xpath(Webelements.RoleAccess));
	    RoleAccess.click();
	    test.log(LogStatus.PASS, "Role Access selected.");

	    // Click on the User Access checkbox
	    WebElement UserAccess = driver.findElement(By.xpath(Webelements.UserAccess));
	    UserAccess.click();
	    test.log(LogStatus.PASS, "User Access selected.");

	    // Click on the Entity Access checkbox
	    WebElement EntityAccess = driver.findElement(By.xpath(Webelements.EntityAccess));
	    EntityAccess.click();
	    test.log(LogStatus.PASS, "Entity Access selected.");

	    // Click on the Service Access checkbox
	    WebElement ServiceAccess = driver.findElement(By.xpath(Webelements.ServiceAccess));
	    ServiceAccess.click();
	    test.log(LogStatus.PASS, "Service Access selected.");

	    // Click on the Group Access checkbox
	    WebElement GroupAccess = driver.findElement(By.xpath(Webelements.GroupAccess));
	    GroupAccess.click();
	    test.log(LogStatus.PASS, "Group Access selected.");

	    // Click on the Report Access checkbox
	    WebElement ReportAccess = driver.findElement(By.xpath(Webelements.ReportAccess));
	    ReportAccess.click();
	    test.log(LogStatus.PASS, "Report Access selected.");

	    // Click on the Audit Access checkbox
	    WebElement AuditAccess = driver.findElement(By.xpath(Webelements.AuditAccess));
	    AuditAccess.click();
	...
	@Test
	public static void selectaudit() throws InterruptedException {
		WebElement AuditAccess = driver.findElement(By.xpath(Webelements.AuditAccess));
		AuditAccess.click();
		Thread.sleep(600);
	...
	public static void save() throws InterruptedException {
		...
		WebElement rolesaveaccess = driver.findElement(By.xpath(Webelements.savebtn));
		rolesaveaccess.click();
	...
	@Test
	public static void changepwdsave() throws InterruptedException {

		WebElement rolesaveaccess = driver.findElement(By.xpath(Webelements.chnagepwdsavebtn));
		rolesaveaccess.click();
		Thread.sleep(500);
	...
	@Test
	public static void savebtnARAB() throws InterruptedException {
	    try {
	        // Locate the 'Save' button (Arabic version)
	        WebElement rolesaveaccess = driver.findElement(By.xpath(Webelements.savebtnARAB));
	...
	@Test
	public static void verifyAddedRole() throws InterruptedException {
	    try {
	        // Click on the Role Tab
	        clickroleTab();
	        test.log(LogStatus.PASS, "Role Tab clicked successfully.");
	        ...
	        while (driver.getPageSource().contains("Next")) {
	            ...
	            WebElement rolenextbtn = driver.findElement(By.xpath(Webelements.nextbtn));
	            rolenextbtn.click();
	        }
	...
	@Test
	public static void verifyAddedRoleARAB() throws InterruptedException {
	    try {
	...
	public void reset() throws Exception {
	    try {
	        ...
	        WebElement reset = driver.findElement(By.xpath(Webelements.Reset));
	        reset.click();
	...
	public void resetARAB() throws InterruptedException {
	    try {
	        ...
	        WebElement resetARAB = driver.findElement(By.xpath(Webelements.ResetARAB));
	...
	public void roleEditTXN() throws InterruptedException {
	    try {
	        ...
	        WebElement editrole = driver.findElement(By.xpath(Webelements.roleeditbtn));
	        editrole.click();
	...
	public void roleEditTXNARAB() throws InterruptedException {
	    try {
	        ...
	        WebElement editroleARAB = driver.findElement(By.xpath(Webelements.roleeditbtn));
	        editroleARAB.click();
	...
	public void roleDeleteTXN() throws InterruptedException {
		...
		if (driver.getPageSource().contains("First")) {
			WebElement rolefirst = driver.findElement(By.xpath(Webelements.firstbtn));
			rolefirst.click();
		}

		WebElement roledelete = driver.findElement(By.xpath(Webelements.roleDeletebtn));
		roledelete.click();
		Thread.sleep(500);
	...
	public void roleDeleteTXNARAB() throws InterruptedException {
	    try {
	        ...
	        if (driver.getPageSource().contains("Ø£ÙˆÙ„Ø§Ù‹")) {
	            WebElement rolefirstARAB = driver.findElement(By.xpath(Webelements.firstbtnARAB));
	            rolefirstARAB.click();
	        ...
	        WebElement roledeleteARAB = driver.findElement(By.xpath(Webelements.roleDeletebtn));
	        roledeleteARAB.click();
	...
	// ****************************************SERVICE_STARTS***************************************************
	@Test
	public static void servicedeletebtn1() throws Exception {
		
		WebElement clickservicedeletebtn = driver.findElement(By.xpath(Webelements.serviceDeletebtn1));
		clickservicedeletebtn.click();
		Thread.sleep(500);
		Alert alert = driver.switchTo().alert();
		alert.accept();
	...
	@Test
	public static void servicedeletebtn2() throws Exception {
		WebElement clickservicedeletebtn = driver.findElement(By.xpath(Webelements.serviceDeletebtn2));
		clickservicedeletebtn.click();
		Thread.sleep(500);
		Alert alert = driver.switchTo().alert();
		alert.accept();
	...
	@Test
	public static void servicedeletebtn3() throws Exception {
		WebElement clickservicedeletebtn = driver.findElement(By.xpath(Webelements.serviceDeletebtn3));
		clickservicedeletebtn.click();
		Thread.sleep(500);
		Alert alert = driver.switchTo().alert();
		alert.accept();
	...
	@Test
	public static void servicedeletebtn4() throws Exception {
		WebElement clickservicedeletebtn = driver.findElement(By.xpath(Webelements.serviceDeletebtn4));
		clickservicedeletebtn.click();
		Thread.sleep(500);
		Alert alert = driver.switchTo().alert();
		alert.accept();
	...
	@Test
	public static void serviceDelete1() throws Exception {
	    try {
	        ...
	        if (driver.getPageSource().contains("Delete")) {
	            ...
	            String screenshotPath = Screenshot.captureScreenShot(driver, "servicedeletebtn1 deleted Successfully");
	            if (screenshotPath != null) {
	                // Convert screenshot to Base64 for embedding in the report
	                String base64Image = encodeImageToBase64(screenshotPath);
	                String imgTag = "<img src='data:image/png;base64," + base64Image + "' alt='Service Delete Screenshot 1' width='500' height='200' />";
	...
	public static void
			...
			serviceDelete2() throws Exception {
	    try {
	        // Step 1: Click on the Service Tab and Search for Service ID
	        serviceTabbtn();
	        searchserviceID();
	...
	@Test
	public static void serviceDelete3() throws Exception {
	    try {
	        // Step 1: Click on the Service Tab and Search for Service ID
	        serviceTabbtn();
	        searchserviceID();
	...
	@Test
	public static void navigatebtns() throws Exception {

		Thread.sleep(500);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,700)");
		WebElement nxtbtn = driver.findElement(By.xpath("//label[text()='Next']"));
		nxtbtn.click();
		js.executeScript("window.scrollBy(0,700)");
		Thread.sleep(200);
		WebElement prvbtn = driver.findElement(By.xpath("//label[text()='Previous']"));
		prvbtn.click();
		js.executeScript("window.scrollBy(0,700)");
		Thread.sleep(200);
		WebElement lastbtn = driver.findElement(By.xpath("//label[text()='Last']"));
		lastbtn.click();
		js.executeScript("window.scrollBy(0,700)");
		Thread.sleep(200);
		WebElement firstbtn = driver.findElement(By.xpath("//label[text()='First']"));
		firstbtn.click();
		js.executeScript("window.scrollBy(0,700)");
		Thread.sleep(200);
	...
	@Test
	public static void serviceview() throws Exception {
		WebElement srvcview = driver.findElement(By.xpath(Webelements.srvcView));
		srvcview.click();
		Thread.sleep(500);
	...
	@Test
	public static void ViewNewServiceFIXED() throws Exception {
	...
	@Test
	public static void serviceEdit() throws Exception {
		WebElement srvEdit = driver.findElement(By.xpath(Webelements.srvcedit));
		srvEdit.click();
		Thread.sleep(500);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,700)");
	...
	@Test
	public static void EditNewServiceFIXEDServiceID() throws Exception {
	...
	public void SendforReviewServiceID() throws Exception {
	    try {
	        ...
	        WebElement sendforreview = driver.findElement(By.xpath(Webelements.sndforReview));
	        sendforreview.click();
	...
	public void ApproveServiceID() throws Exception {
	    try {
	        ...
	        WebElement approveServiceID = driver.findElement(By.xpath(Webelements.approve));
	        approveServiceID.click();
	...
	public void RejectServiceID() throws Exception {
	    try {
	        ...
	        WebElement RejectServiceID = driver.findElement(By.xpath(Webelements.reject));
	        RejectServiceID.click();
	...
	@Test
	public static void serviceTabbtn() throws Exception {
	    try {
	        // Step 1: Wait for a moment to ensure the element is loaded
	        Thread.sleep(500);
	        
	        // Step 2: Find the Service Tab button using XPath
	        WebElement clickServiceTab = driver.findElement(By.xpath(Webelements.servicetabbtn));
	        
	        // Step 3: Click on the Service Tab button
	        clickServiceTab.click();
	...
	public void BlankserviceID() throws Exception {
	    try {
	        ...
	        // Step 2: Set service details excluding Service ID
	        selectserviceentity();
	        enterserviceGlCode();
	        enterpgaCode();
	        enterserviceNameEnglish();
	...
	@Test
	public void BlankServiceNameARA() throws Exception {
	    try {
	        // Step 1: Navigate to the service tab
	        serviceTabbtn();
	...
	@Test
	public static void enterserviceId() throws Exception {
	...
	@Test
	public static void selectserviceentity() throws Exception {
		Select select = new Select(driver.findElement(By.xpath(Webelements.entitydrop)));
	...
	@Test
	public static void enterserviceGlCode() throws Exception {
		WebElement srvcGlCode = driver.findElement(By.xpath(Webelements.ServiceGLCode));
		srvcGlCode.clear();
	...
	@Test
	public static void enterpgaCode() throws Exception {
		WebElement pgCode = driver.findElement(By.xpath(Webelements.PGACode));
	...
	@Test
	public static void enterserviceNameEnglish() throws Exception {
		WebElement serviceNameEnglish = driver.findElement(By.xpath(Webelements.ServiceNameEnglish));
	...
	@Test
	public static void enterserviceNameArabic() throws Exception {
		WebElement serviceNameArabic = driver.findElement(By.xpath(Webelements.ServiceNameArabic));
	...
	@Test
	public static void serviceCategory() throws Exception {
		WebElement serviceCategories = driver.findElement(By.xpath(Webelements.Category));
		serviceCategories.click();
		Select serviceCategory1 = new Select(driver.findElement(By.xpath(Webelements.Category)));
	...
	@Test
	public static void serviceTypeFixed() throws Exception {
		WebElement servicetypes = driver.findElement(By.xpath(Webelements.ServiceType));
		servicetypes.click();
		Thread.sleep(600);
		Select serviceFixed = new Select(driver.findElement(By.xpath(Webelements.ServiceType)));
	...
	@Test
	public static void serviceTypePercent() throws Exception {
		WebElement servicetypes = driver.findElement(By.xpath(Webelements.ServiceType));
		servicetypes.click();
		Thread.sleep(600);
		Select serviceFixed = new Select(driver.findElement(By.xpath(Webelements.ServiceType)));
	...
	@Test
	public static void serviceTypeUnit() throws Exception {
		WebElement servicetypes = driver.findElement(By.xpath(Webelements.ServiceType));
		servicetypes.click();
		Thread.sleep(600);
		Select serviceFixed = new Select(driver.findElement(By.xpath(Webelements.ServiceType)));
		...
		Thread.sleep(600);
		WebElement Unitprice = driver.findElement(By.xpath(Webelements.UnitPrice));
		Unitprice.sendKeys(ExcelUtilities.UnitPricecolumn);
		entermaximumQuantity();
	}

	@Test
	public static void serviceTypeVariable() throws Exception {
		WebElement servicetypes = driver.findElement(By.xpath(Webelements.ServiceType));
		servicetypes.click();
		Thread.sleep(600);
		Select serviceFixed = new Select(driver.findElement(By.xpath(Webelements.ServiceType)));
	...
	@Test
	public static void enterserviceMinimumPrice() throws Exception {
		WebElement servicePrice = driver.findElement(By.xpath(Webelements.MinimumPrice));
		servicePrice.sendKeys(ExcelUtilities.MinimumPricecolumn);
		Thread.sleep(500);
	}

	@Test
	public static void selectsubcatagory() throws Exception {
		WebElement servicetypes = driver.findElement(By.xpath(Webelements.SubCategory));
		servicetypes.click();
		Thread.sleep(600);
	...
	@Test
	public static void enterserviceTypeUnit() throws Exception {
		WebElement servicetypes = driver.findElement(By.xpath(Webelements.UnitPrice));
		servicetypes.click();
		Thread.sleep(600);
		WebElement servicePercent = driver.findElement(By.partialLinkText(ExcelUtilities.UnitPricecolumn));
		servicePercent.click();
		Thread.sleep(600);
	}

	@Test
	public static void enterserviceTypeVariable() throws Exception {
		WebElement servicetypes = driver.findElement(By.xpath("//select[@id='serviceTypesForService']"));
		servicetypes.click();
		Thread.sleep(600);
		WebElement servicePercent = driver.findElement(By.partialLinkText("Variable"));
		servicePercent.click();
		Thread.sleep(600);
	}

	@Test
	public static void enterservicePrice() throws Exception {
		WebElement servicePrice = driver.findElement(By.xpath(Webelements.ServicePrice));
		servicePrice.clear();
		servicePrice.sendKeys(ExcelUtilities.ServicePricecolumn);
		Thread.sleep(500);
		test.log(LogStatus.PASS, " Enter Service Price  :" + ExcelUtilities.ServicePricecolumn);
	}

	@Test
	public static void entermaximumQuantity() throws Exception {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,500)");
		Thread.sleep(500);
		WebElement maximumQuantity = driver.findElement(By.xpath(Webelements.MaximumQuantity));
		maximumQuantity.clear();
		maximumQuantity.sendKeys(ExcelUtilities.MaximumQuantitycolumn);
		Thread.sleep(500);
		test.log(LogStatus.PASS, " Enter Service Maximum quantity :" + ExcelUtilities.MaximumQuantitycolumn);
	}

	@Test
	public static void selecteffecitvestartdate() throws Exception {

		WebElement effstrtdte = driver.findElement(By.xpath(Webelements.effstrtdte));
		effstrtdte.click();

		effstrtdte.sendKeys("1");
		Robot r = new Robot();
		...
		act.moveToElement(effstrtdte, 450, 20).click().build().perform();
		for (int i = 1; i <= 2; i++) {
			Robot r = new Robot();
			r.keyPress(KeyEvent.VK_TAB);
			r.keyRelease(KeyEvent.VK_TAB);
		...
		Thread.sleep(500);
		test.log(LogStatus.PASS, "  Service ID  Start effective Date ");*/
	}

	@Test
	public static void selecteffecitveenddate() throws Exception {
		WebElement effenddte = driver.findElement(By.xpath(Webelements.effenddte));
		effenddte.click();
		Actions act = new Actions(driver);
		act.moveToElement(effenddte, 454, 14).click().build().perform();
		Thread.sleep(500);
		for (int i = 1; i <= 8; i++) {
			Robot r = new Robot();
			r.keyPress(KeyEvent.VK_TAB);
		...
		r.keyRelease(KeyEvent.VK_ENTER);
		Thread.sleep(500);
		test.log(LogStatus.PASS, "  Service ID  End effective Date ");
	}

	@Test
	public static void selectvatValuesServicesVAT1() throws Exception {
		WebElement serviceVAT1 = driver.findElement(By.xpath(Webelements.ServiceVAT));
		serviceVAT1.click();
		Thread.sleep(500);
		Select serviceV1 = new Select(driver.findElement(By.xpath(Webelements.ServiceVAT)));
	...
	@Test
	public static void selectvatValuesServicesVAT2() throws Exception {
		WebElement serviceVAT2 = driver.findElement(By.xpath(Webelements.ServiceVAT));
		serviceVAT2.click();
		Thread.sleep(500);
		Select serviceV2 = new Select(driver.findElement(By.xpath(Webelements.ServiceVAT)));
		serviceV2.selectByIndex(2);
		Thread.sleep(500);
	}

	@Test
	public static void selectvatValuesServicesVAT3() throws Exception {
		WebElement serviceVAT3 = driver.findElement(By.xpath(Webelements.ServiceVAT));
		serviceVAT3.click();
		Thread.sleep(500);
		Select serviceV3 = new Select(driver.findElement(By.xpath(Webelements.ServiceVAT)));
		serviceV3.selectByIndex(3);
		Thread.sleep(500);
	}

	@Test
	public static void selectvatValuesServicesVAT4() throws Exception {
		WebElement serviceVAT4 = driver.findElement(By.xpath(Webelements.ServiceVAT));
		serviceVAT4.click();
		Thread.sleep(500);
		Select serviceV4 = new Select(driver.findElement(By.xpath(Webelements.ServiceVAT)));
		serviceV4.selectByIndex(4);
		Thread.sleep(500);
	}

	@Test
	public static void serviceStatusActive() throws Exception {
		WebElement StatusForServices1 = driver.findElement(By.xpath(Webelements.ServiceStatus));
		StatusForServices1.click();
		Thread.sleep(600);
		Select serviceActive = new Select(driver.findElement(By.xpath(Webelements.ServiceStatus)));
	...
	@Test
	public static void selectserviceStatusForServices2() throws Exception {
		WebElement StatusForServices2 = driver.findElement(By.xpath(Webelements.ServiceStatus));
		StatusForServices2.click();
		Thread.sleep(600);
		Select serviceStatusForServices = new Select(driver.findElement(By.xpath(Webelements.ServiceStatus)));
		serviceStatusForServices.selectByIndex(2);
		Thread.sleep(500);
	}

	@Test
	public static void searchserviceID() throws Exception {
	    try {
	        ...
	        servchk.sendKeys(ExcelUtilities.serviceIDcolumn);
	        Thread.sleep(2000); // Wait for the ID to be entered

	        // Step 2: Click on the search button
	        WebElement servsrh = driver.findElement(By.xpath(Webelements.servsrh));
	        servsrh.click();
	...
	public void EnterKeyLogin() throws InterruptedException, AWTException {
	    ...
	    WebElement InputPasswordEnter = driver.findElement(By.xpath(Webelements.Inputpassword));
	    InputPasswordEnter.click();
	...
	public void Logout_ENG() throws Exception {
		...
		Thread.sleep(1000);
		WebElement userLogout = driver.findElement(By.xpath(Webelements.userLogout));
		userLogout.click();
		Thread.sleep(600);
		//Actions act = new Actions(driver);
		//act.moveToElement(userLogout, 0, 0).click().build().perform();

		WebElement alertLogoutbtn = driver.findElement(By.xpath(Webelements.alertLogoutbtnENG));
		...
		if (driver.getPageSource().contains("Logged out successfully.")) {
			...
			login();
			Thread.sleep(600);
			WebElement AutheticLogout = driver.findElement(By.xpath(Webelements.AuthlogoutENG));
			// act.moveToElement(AutheticLogout).perform();
			AutheticLogout.click();
			JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("window.scrollBy(0,500)");
			WebElement alertAuthLogoutbtn = driver.findElement(By.xpath(Webelements.alertLogoutbtnENG));
			alertAuthLogoutbtn.click();
			Thread.sleep(600);
			if (driver.getPageSource().contains("Logged out successfully.")) {
	...
	public void Logout_ARAB() throws Exception {
		...
		userLogout.click();
		Actions act = new Actions(driver);
		act.moveToElement(userLogout, 85, 30).click().build().perform();

		Thread.sleep(600);
		WebElement userLogoutbtn = driver.findElement(By.xpath(Webelements.userLogoutbtnARAB));
		userLogoutbtn.click();
		Thread.sleep(600);
		WebElement alertLogoutbtn = driver.findElement(By.xpath(Webelements.alertLogoutbtnARAB));
		alertLogoutbtn.click();
		Thread.sleep(600);
		if (driver.getPageSource().contains("Logged out successfully.")) {
		...
		Thread.sleep(600);
		WebElement AutheticLogout = driver.findElement(By.xpath(Webelements.AuthlogoutARAB));

		act.moveToElement(AutheticLogout).perform();
		AutheticLogout.click();
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,500)");
		WebElement alertAuthLogoutbtn = driver.findElement(By.xpath(Webelements.alertLogoutbtnARAB));
		alertAuthLogoutbtn.click();
		Thread.sleep(600);
		if (driver.getPageSource().contains("Logged out successfully.")) {
	...
	public void USERclicktab() throws InterruptedException {
		WebElement clickonUserTab = driver.findElement(By.xpath(Webelements.USERtab));
	...
	public void USERUserFullname() throws Exception {
		WebElement EnterFullname = driver.findElement(By.xpath(Webelements.UserFullname));
	...
	public void USERUsername() throws Exception {
		WebElement EnterUsername = driver.findElement(By.xpath(Webelements.Username1));
	...
	public void USERPassword() throws Exception {
		WebElement EnterPassword = driver.findElement(By.xpath(Webelements.Password1));
	...
	public void USERtogglepwd() throws Exception {
		WebElement togglepassword = driver.findElement(By.xpath(Webelements.togglepwd));
	...
	public void USERconfirmPassword() throws Exception {
		WebElement ConfirmPassword = driver.findElement(By.xpath(Webelements.confirmPassword));
	...
	public void USERtoggleconfirmPwd() throws Exception {
		WebElement toggleConfirmPassword = driver.findElement(By.xpath(Webelements.toggleconfirmPwd));
	...
	public void USERemailId() throws Exception {
		WebElement EmailId = driver.findElement(By.xpath(Webelements.emailId));
	...
	public void USERcontactNo() throws Exception {
		WebElement ContactNo = driver.findElement(By.xpath(Webelements.contactNo));
		ContactNo.clear();
	...
	public void USERcheckercheckmark() throws Exception {
		...
		WebElement checkerconfirmation = driver.findElement(By.xpath(Webelements.checkmark1));
		checkerconfirmation.click();
		Thread.sleep(600);
	...
	public void USERselectuserRole() throws Exception {
		Select UserRole = new Select(driver.findElement(By.xpath(Webelements.selectuserRole)));
	...
	public void USERstatuscheckmark2() throws Exception {
		WebElement checkerconfirmation2 = driver.findElement(By.xpath(Webelements.checkmark2));
		checkerconfirmation2.click();
		Thread.sleep(600);
	...
	public void CreateNEWUser() throws Exception {
	    try {
	        ...
	        if (driver.getPageSource().contains("ADMINTEST")) {
	            ...
	            test.log(LogStatus.FAIL, "New User creation failed.");
	        }
	...
	public void USEROwndeleteTXN() throws InterruptedException {
		...
		js.executeScript("window.scrollBy(0,1000)");
		Thread.sleep(600);
		WebElement userdelete = driver.findElement(By.xpath(Webelements.userDeletebtn));
		userdelete.click();
		Thread.sleep(500);
	...
	public void UserLoginPortalChangePWD() throws Exception {
		// login();
		 WebElement Change_Password = driver.findElement(By.xpath(Webelements.ChangePassword));
		 Change_Password.click();
		 Thread.sleep(600);
		 WebElement chngusername = driver.findElement(By.xpath(Webelements.loginchngUsername));
		 chngusername.sendKeys(ExcelUtilities.user_login_chng_usernamevalue);
		 Thread.sleep(600);
		 WebElement chngoldpwd = driver.findElement(By.xpath(Webelements.oldPassword));
		 chngoldpwd.sendKeys(ExcelUtilities.user_oldpasswordvalue);
		 Thread.sleep(600);
		 WebElement chngoldpwdeye = driver.findElement(By.xpath(Webelements.toggleOldPassword));
		chngoldpwdeye.click();
		 Thread.sleep(600);
		 WebElement chngNewpwd = driver.findElement(By.xpath(Webelements.password));
		 chngNewpwd.sendKeys(ExcelUtilities.user_newpasswordvalue);
		 Thread.sleep(600);
		 WebElement chngNewpwdeye = driver.findElement(By.xpath(Webelements.toggleNewPassword));
		 chngNewpwdeye.click();
		 Thread.sleep(600);
	 WebElement chngconfirmpwd = driver.findElement(By.xpath(Webelements.confirmchngPassword));
		 chngconfirmpwd.sendKeys(ExcelUtilities.user_confirmpasswordvalue);
		 Thread.sleep(600);
		WebElement chngconfirmpwdeye = driver.findElement(By.xpath(Webelements.toggleConfirmPassword));
		 chngconfirmpwdeye.click();
	 Thread.sleep(600);
		 changepwdsave();
		 WebElement loginbtn = driver.findElement(By.xpath(Webelements.loginsbt));
		 loginbtn.click();
	Thread.sleep(600);
	test.log(LogStatus.PASS, ExcelUtilities.testCaseDesritpioncolumnvalue);
	...
	public void USEReditTXN() throws Exception {
	    try {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.fullnamecolumn)) {
	            ...
	            WebElement USEREdit = driver.findElement(By.xpath(Webelements.userEdit));
	            USEREdit.click();
	...
	public void EditUsername() throws Exception {
	    try {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.fullnamecolumn)) {
	            ...
	            WebElement USERNAMEEdit = driver.findElement(By.xpath(Webelements.EditUsername));
	            USERNAMEEdit.click();
	...
	public void EditPassword() throws Exception {
	    try {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.fullnamecolumn)) {
	            ...
	            WebElement PASSWORDEdit = driver.findElement(By.xpath(Webelements.EditPassword));
	            PASSWORDEdit.click();
	...
	public void EditRole() throws Exception {
	    try {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.fullnamecolumn)) {
	            ...
	            WebElement USERROLEEdit = driver.findElement(By.xpath(Webelements.EditRole));
	            USERROLEEdit.click();
	...
	public void EditEmailID() throws Exception {
	    try {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.fullnamecolumn)) {
	            ...
	            WebElement EMAILIDEdit = driver.findElement(By.xpath(Webelements.EditEmailID));
	            EMAILIDEdit.click();
	...
	public void EditCheckerbox() throws Exception {
	    try {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.fullnamecolumn)) {
	            ...
	            WebElement CHECKEREdit = driver.findElement(By.xpath(Webelements.EditCheckerbox));
	            CHECKEREdit.click();
	...
	public void EditDeselectCheckerbox() throws Exception {
	    try {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.fullnamecolumn)) {
	            ...
	            WebElement DESELECTCHECKEREdit = driver.findElement(By.xpath(Webelements.EditDeselectCheckerbox));
	            DESELECTCHECKEREdit.click();
	...
	public void EditUserAsActive() throws Exception {
	    try {
	        ...
	        WebElement EditUserActive = driver.findElement(By.xpath(Webelements.EditUserActiveCheckbox));
	        EditUserActive.click();
	...
	public void Click_download_button() {
	    try {
	        ...
	        WebElement Click_download_btn = driver.findElement(By.xpath(Webelements.Click_download_button));
			Click_download_btn.click();
	...
	@Test
	public static void resetbtnUSER() {
		WebElement userreset = driver.findElement(By.xpath(Webelements.Reset));
		userreset.click();
	...
	public void verifyAddedUSER() throws InterruptedException {
	    try {
	        ...
	        while (driver.getPageSource().contains("Next")) {
	            ...
	            WebElement usernextbtn = driver.findElement(By.xpath(Webelements.nextbtn));
	            usernextbtn.click();
	        }
	...
	public void clickEntityTab() throws InterruptedException {
		...
		WebElement clickEntityTab = driver.findElement(By.xpath(Webelements.EntityTab));
		clickEntityTab.click();
	...
	public void clickEntityTab_ARAB() throws InterruptedException {
		// TODO Auto-generated method stub
		WebElement clickEntityTab = driver.findElement(By.xpath(Webelements.EntityTabARAB));
		clickEntityTab.click();
	...
	public void entityID() throws InterruptedException {
		WebElement enterEntityID = driver.findElement(By.xpath(Webelements.entityID));
	...
	public void entityGLcode() throws InterruptedException {
		WebElement enterEntityGLcode = driver.findElement(By.xpath(Webelements.entityGLcode));
	...
	public void entityEngName() throws InterruptedException {
		WebElement enterEntityNameENG = driver.findElement(By.xpath(Webelements.entitynameEng));
	...
	public void entityArabName() throws InterruptedException {
		WebElement enterEntityNameARAB = driver.findElement(By.xpath(Webelements.entitynameArab));
	...
	public void entityCatagory() throws InterruptedException {
		Select selectEntityCatagory = new Select(driver.findElement(By.xpath(Webelements.entityCatagory)));
	...
	public void entitytype() throws InterruptedException {
		...
		Select selectEntityType = new Select(driver.findElement(By.xpath(Webelements.entityType)));
	...
	@Test
	public static void verifyAddedEntity() throws InterruptedException {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,1000)");
		Thread.sleep(600);
		// Doubt
	...
	public void verifyEditedEntity() throws InterruptedException {
	    ...
	    while (driver.getPageSource().contains("Next")) {
	        ...
	        WebElement nextButton = driver.findElement(By.xpath(Webelements.nextbtn));
	        nextButton.click();
	    }
	}
	...
	public void EntityEditTXN() throws InterruptedException {
	    ...
	    while (driver.getPageSource().contains("Next")) {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.enterEntityIDcolumn)) {
	            ...
	            WebElement editButton = driver.findElement(By.xpath(Webelements.Entityeditbtn));
	            editButton.click();
	            test.log(LogStatus.PASS, "Clicked on Edit button for Entity");

	            // Clear and update the Entity GL Code
	            WebElement entityGLcodeField = driver.findElement(By.xpath(Webelements.entityGLcode));
	...
	public void EntityDeleteTXN1() throws InterruptedException {
	    ...
	    while (driver.getPageSource().contains("Next")) {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.enterEntityIDcolumn)) {
	            ...
	            WebElement roledelete = driver.findElement(By.xpath(Webelements.EntityDeletebtn1));
	            roledelete.click();
	            Thread.sleep(500);
	        ...
	        WebElement nextbtn = driver.findElement(By.xpath(Webelements.nextbtn));
	        nextbtn.click();
	        Thread.sleep(500); // Optional: Use a better wait strategy if needed
	    }
	}
	...
	public void deleteEntity(String deleteButtonXpath, String testCaseDescription) throws InterruptedException {
	    ...
	    while (driver.getPageSource().contains("Next")) {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.enterEntityIDcolumn)) {
	            ...
	            WebElement roledelete = driver.findElement(By.xpath(deleteButtonXpath));
	            roledelete.click();
	            Thread.sleep(500);
	...
	public void EntityDeleteTXN2() throws InterruptedException {
	    deleteEntity(Webelements.EntityDeletebtn2, ExcelUtilities.testCaseDesritpioncolumnvalue + " - TXN2");
	}

	@Test
	public void EntityDeleteTXN3() throws InterruptedException {
	    deleteEntity(Webelements.EntityDeletebtn3, ExcelUtilities.testCaseDesritpioncolumnvalue + " - TXN3");
	}

	@Test
	public void EntityDeleteTXN4() throws InterruptedException {
	    deleteEntity(Webelements.EntityDeletebtn4, ExcelUtilities.testCaseDesritpioncolumnvalue + " - TXN4");
	}
	...
	public void EntityDeleteTXN() throws InterruptedException {
	    ...
	    while (driver.getPageSource().contains("Next")) {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.enterEntityIDcolumn)) {
	            ...
	            // Click on the delete button for the entity
	            WebElement roledelete = driver.findElement(By.xpath(Webelements.EntityDeletebtn));
	            roledelete.click();
	            Thread.sleep(500);
	...
	public void verifyDeletedEntity() throws InterruptedException {
	    ...
	    // Click the next button to go to the next page
	    WebElement rolenextbtn2 = driver.findElement(By.xpath(Webelements.nextbtn));
	    rolenextbtn2.click();
	}
	...
	public void grouptabARAB() throws InterruptedException {
		...
		WebElement clickgrouptab = driver.findElement(By.xpath(Webelements.grouptabARAB));
		clickgrouptab.click();
		Thread.sleep(500);
	}
	...
	public void grouptab() throws InterruptedException {
		...
		WebElement clickgrouptab = driver.findElement(By.xpath(Webelements.grouptab));
		clickgrouptab.click();
		Thread.sleep(500);
	...
	public void groupcode() throws InterruptedException {
		...
		WebElement entergroupcode = driver.findElement(By.xpath(Webelements.groupcode));
	...
	public void groupEngName() throws InterruptedException {
		...
		WebElement entergroupEngName = driver.findElement(By.xpath(Webelements.groupEngName));
	...
	public void groupArabName() throws InterruptedException {
		...
		WebElement entergroupArabName = driver.findElement(By.xpath(Webelements.groupArabName));
	...
	public void groupEnity() throws InterruptedException {
		...
		Select selectgroupEntity = new Select(driver.findElement(By.xpath(Webelements.groupEntity)));
	...
	public void groupService1() throws InterruptedException {
		...
		Select selectgroupservice1 = new Select(driver.findElement(By.xpath(Webelements.groupservice)));
	...
	public void groupService2() throws InterruptedException {
		...
		Select selectgroupservice2 = new Select(driver.findElement(By.xpath(Webelements.groupservice)));
	...
	public void groupService3() throws InterruptedException {
		...
		Select selectgroupservice3 = new Select(driver.findElement(By.xpath(Webelements.groupservice)));
	...
	public void groupService4() throws InterruptedException {
		...
		Select selectgroupservice4 = new Select(driver.findElement(By.xpath(Webelements.groupservice)));
	...
	public void serviceplusbtn() {
		WebElement groupserviceaddbtn = driver.findElement(By.xpath(Webelements.groupserviceadd));
		groupserviceaddbtn.click();
		test.log(LogStatus.PASS, "Click on Group Service Add Button");

	}

	@Test
	public static void verifyAddedGroup() throws InterruptedException {
	    try {
	...
	public void GroupViewTXN() throws InterruptedException {
	    try {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.groupcodecolumn)) {
	            ...
	            WebElement view = driver.findElement(By.xpath(Webelements.GroupViewbtn));
	            view.click();
	            js.executeScript("window.scrollBy(0,50)");
	...
	public void GroupDeleteTXN() throws InterruptedException {
	    try {
	        ...
	        if (driver.getPageSource().contains(ExcelUtilities.groupcodecolumn)) {
	            ...
	            WebElement GrpRec = driver.findElement(By.xpath(Webelements.GroupDeletebtn));
	            GrpRec.click();
	...
	public void groupservicedeletebtn1() throws Exception {
		WebElement tsrr = driver.findElement(By.xpath(Webelements.groupsrvdeletebtn1));
		tsrr.click();
		Thread.sleep(500);
	...
	public void groupservicedeletebtn2() throws Exception {
		WebElement testname = driver.findElement(By.xpath(Webelements.groupsrvdeletebtn2));
		testname.click();
		Thread.sleep(500);
	...
	// ***************************************MIS_STARTS****************************************************
	@Test
	public static void viewMIS() throws InterruptedException {
		WebElement viewMIS = driver.findElement(By.xpath(Webelements.MIStab));
		viewMIS.click();
		Thread.sleep(500);
	...
	@Test
	public static void misdate() throws InterruptedException, Exception {
	...
	@Test
	public static void misdateARAB() throws InterruptedException, Exception {
	...
	@Test
	public static void misenddate() throws InterruptedException, Exception {

		// WebElement clickMIS = driver.findElement(By.linkText("MIS"));
		// clickMIS.click();
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	@Test
	public static void clkview() throws InterruptedException {

		WebElement clkmisview = driver.findElement(By.xpath(Webelements.View));
		Thread.sleep(500);
		clkmisview.click();
		Screenshot.captureScreenShot(driver, ExcelUtilities.testCaseDesritpioncolumnvalue);
	...
	public static void download() throws InterruptedException {
		WebElement download = driver.findElement(By.xpath(Webelements.download));
	...
	public void clklang() throws InterruptedException {
	    try {
	    	...
	    	WebElement langchng = driver.findElement(By.xpath(Webelements.lang));
			langchng.click();
	        ...
	        Select select = new Select(driver.findElement(By.xpath(Webelements.lang)));
	...
	@Test
	public static void viewMISAR() throws InterruptedException {
	    try {
	        WebElement viewMISAR = driver.findElement(By.xpath(Webelements.viewMISAR));
	        viewMISAR.click();
	        Thread.sleep(2000);
	...
	@Test
	public static void viewAudit() throws InterruptedException {
	    try {
	        WebElement viewAudit = driver.findElement(By.xpath(Webelements.AuditTab));
	        viewAudit.click();
	        Thread.sleep(500);
	...
	public void misdownload() throws Exception {
	    try {
	        WebElement MisDownload = driver.findElement(By.xpath(Webelements.MisDownloadbtn));
	        MisDownload.click();
	        Thread.sleep(500);
	...
	public void clkviewARAB() throws Exception {
	    try {
	        WebElement MISviewArb = driver.findElement(By.xpath(Webelements.MISviewArbbtn));
	        MISviewArb.click();
	        Thread.sleep(500);
	...
	public void misdownloadARAB() throws Exception {
	    try {
	        WebElement MISDownloadArb = driver.findElement(By.xpath(Webelements.MISDownloadArbbtn));
	        MISDownloadArb.click();
	        Thread.sleep(500);
	...
	@Test
	public static void auditdate() throws InterruptedException, Exception {
	    try {
	        JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("window.scrollBy(0,500)");
	        Actions act = new Actions(driver);
			...
			((JavascriptExecutor) driver).executeScript("arguments[0].value = '2023-10-01T12:00';", effstrtdte);
	        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	        test.log(LogStatus.PASS, "Select Effective Start Audit Date");
	        ...
	        if (screenshotPath != null) {
	            String base64Image = encodeImageToBase64(screenshotPath);
	            String imgTag = "<img src='data:image/png;base64," + base64Image + "' alt='Audit Start Date Screenshot' width='500' height='200' />";
	            test.log(LogStatus.PASS, "Audit Start Date selected successfully. " + imgTag);
	        } else {
	...
	@Test
	public static void auditenddate() throws InterruptedException, Exception {
	    try {
	        JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("window.scrollBy(0,500)");
	        Actions act = new Actions(driver);
			...
			((JavascriptExecutor) driver).executeScript("arguments[0].value = '2025-10-01T12:00';", effenddte);
	        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	        test.log(LogStatus.PASS, "Select Effective End Audit Date");
	        ...
	        if (screenshotPath != null) {
	            String base64Image = encodeImageToBase64(screenshotPath);
	            String imgTag = "<img src='data:image/png;base64," + base64Image + "' alt='Audit End Date Screenshot' width='500' height='200' />";
	            test.log(LogStatus.PASS, "Audit End Date selected successfully. " + imgTag);
	        } else {
	...
	public static void module() throws InterruptedException {
	    try {
	        Select selectauditModule = new Select(driver.findElement(By.xpath(Webelements.AuditModule)));
	...
	@Test
	public static void invaliddate() throws InterruptedException, Exception {
	    try {
	        JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("window.scrollBy(0,500)");
	...
	@Test
	public static void invalidenddate() throws InterruptedException, Exception {
	    try {
	        JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("window.scrollBy(0,500)");
	...
	@Test
	public static void VerifyMISerror() throws InterruptedException {
	    try {
	...
	@Test
	public static void paginationnxt() throws InterruptedException {
	    try {
	        WebElement pagination = driver.findElement(By.xpath(Webelements.nextbtn));
	        Thread.sleep(2000);
	        pagination.click();
	        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	...
	@Test
	public static void AuditEn() throws InterruptedException {
	    try {
	        Select select = new Select(driver.findElement(By.xpath(Webelements.lang)));
	...
	public class AuditTest {
	    ...
	    public void AuditallModule() throws Exception {
	        try {
	            ...
	            // Screenshot path (replace with actual path or method to get screenshot)
	            String screenshotPath = "path/to/screenshot_AuditallModule.png";  // Replace with actual path
	            String imgTag = generateImgTag(screenshotPath);

	            test.log(LogStatus.PASS, "Audit All Module executed successfully. " + imgTag);

	        } catch (Exception e) {
	            test.log(LogStatus.FAIL, "Error during Audit All Module execution: " + e.getMessage());
	        }
	    }
	...
	public void clickonMISreportBtn() throws Exception {
	    try {
	        WebElement MISrerportbtn = driver.findElement(By.xpath(Webelements.MISReportbtn));
	        MISrerportbtn.click();
	        Thread.sleep(600);
	        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	...
	public void clickonMISreportBtnAR() throws Exception {
	    try {
	        WebElement MISrerportbtnAR = driver.findElement(By.xpath(Webelements.MISReportbtnARAB));
	        MISrerportbtnAR.click();
	        Thread.sleep(600);
	        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	...
	public void MisreportARABbtn() throws Exception {
	    try {
	        WebElement MISreportArbbtn = driver.findElement(By.xpath(Webelements.MISReportbtnARAB));
	        MISreportArbbtn.click();
	    } catch (Exception e) {
	...
	public void clickonMISreportBtnARAB() throws Exception {
	    try {
	        WebElement MISrerportbtnARAB = driver.findElement(By.xpath(Webelements.MISReportbtnARAB));
	        MISrerportbtnARAB.click();
	        Thread.sleep(600);
	        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
...
@Test
	public void LoginPortalChangePWD() throws InterruptedException {
	    try {
	        ...
	        WebElement changePasswordButton = driver.findElement(By.xpath(Webelements.ChangePassword));
	        changePasswordButton.click();
	        Thread.sleep(600);  // Wait for the page to load

	        // Enter the username for password change
	        WebElement usernameField = driver.findElement(By.xpath(Webelements.loginchngUsername));
	        usernameField.sendKeys(ExcelUtilities.LOGIN_CHNG_USERNAMEcolumn);
	        Thread.sleep(600);

	        // Enter the old password
	        WebElement oldPasswordField = driver.findElement(By.xpath(Webelements.oldPassword));
	        oldPasswordField.sendKeys(ExcelUtilities.OLDPASSWORDcolumn);
	        WebElement oldPasswordEye = driver.findElement(By.xpath(Webelements.toggleOldPassword));
	        oldPasswordEye.click();  // Toggle old password visibility
	        Thread.sleep(600);

	        // Enter the new password
	        WebElement newPasswordField = driver.findElement(By.xpath(Webelements.password));
	        newPasswordField.sendKeys(ExcelUtilities.NEWPASSWORDcolumn);
	        WebElement newPasswordEye = driver.findElement(By.xpath(Webelements.toggleNewPassword));
	        newPasswordEye.click();  // Toggle new password visibility
	        Thread.sleep(600);

	        // Enter the confirm password
	        WebElement confirmPasswordField = driver.findElement(By.xpath(Webelements.confirmchngPassword));
	        confirmPasswordField.sendKeys(ExcelUtilities.CONFIRMPASSWORDcolumn);
	        WebElement confirmPasswordEye = driver.findElement(By.xpath(Webelements.toggleConfirmPassword));
	        confirmPasswordEye.click();  // Toggle confirm password visibility
	        Thread.sleep(600);
	        ...
	        WebElement loginButton = driver.findElement(By.xpath(Webelements.loginsbt));
	        loginButton.click();
	        Thread.sleep(600);
	...
	public void Changepass_EnterOldpass_click() throws InterruptedException {
	    try {
	        ...
	        WebElement oldPassword = driver.findElement(By.xpath(Webelements.oldPassword1));
	        ...
	        WebElement eyeOldPwd = driver.findElement(By.xpath(Webelements.eyeoldpwd));
	        eyeOldPwd.click();
	...
	public void Changepass_EnterNewpass_click() throws InterruptedException {
		WebElement NewPassword = driver.findElement(By.xpath(Webelements.confirmchngPassword1));
		NewPassword.sendKeys(ExcelUtilities.NEWPASSWORDcolumn);
		Thread.sleep(600);
		WebElement eyeNewpwd1 = driver.findElement(By.xpath(Webelements.eyeNewpwd));
		eyeNewpwd1.click();
		Thread.sleep(600);
	...
	public void Changepass_EnterConfirmpass_click() throws InterruptedException {
		WebElement cnfrimpwd = driver.findElement(By.xpath(Webelements.cnfrimpwd1));
		cnfrimpwd.sendKeys(ExcelUtilities.CONFIRMPASSWORDcolumn);
		Thread.sleep(600);
		WebElement eyeconfirmpwd1 = driver.findElement(By.xpath(Webelements.eyecnfrimpwd1));
		eyeconfirmpwd1.click();
		Thread.sleep(600);
	...
	public void Changepass_Tab_click() throws Exception {
		WebElement ChangePassword = driver.findElement(By.xpath(Webelements.ChangePassword1));
...
// // testcase = extentReport.createTest("Verify You have logged out
// Successfully text ");
...
//
// @Test
// public static void openthechromeclicksearch() {
//// testcase = extentReport.createTest("Verify Chrome ");
// driver.get(ExcelUtilities.dataColumnValue);
// WebElement serchbtn = driver.findElement(Engine.locator);
// serchbtn.sendKeys("NASA");
